...
class Authentifierpage extends StatefulWidget {
  const Authentifierpage({super.key});

  @override
  State<Authentifierpage> createState() => _EnregistrerState();
}

class _EnregistrerState extends State<Authentifierpage> {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 50),
                PrimaryButton(text: 'CREEZ-COMPTE', onPressed: () {}),
                SizedBox(height: 50),
                Text(
                  "Deja inscrit?",
